...
import com.emak.user.exception.AuthenticationException;
import com.emak.user.exception.DuplicateUserException;
...
public class UserServiceImpl extends BaseService implements UserService, UserDetailsService {
    ...
    public ApiUser authenticate(String username, String password) {
        ...
        //TODO This code needs to be integrated with the User DAO of existing oracle data source
